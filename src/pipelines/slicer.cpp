...
namespace lsqecc
{
            ...
            std::ostream& err_stream)
    {
...
#else
            throw std::runtime_error("Pandora/PostgreSQL not supported in WASM build");
#endif
        }
        ...
        // Set when --graceful swallows an exception and slicing stops before consuming the whole
        // stream.
