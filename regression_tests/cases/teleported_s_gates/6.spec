...
BellBasedCNOT 1 29 30 31 [BellMeasure (1,5),(1,4);MergeContract (0,4),(0,5)];MeasureSinglePatch 29 Z;RequestYState 32 1 [PrepareY (3,4)];
...
BellBasedCNOT 2 33 34 35 [BellMeasure (1,7),(1,6);MergeContract (0,6),(0,7)];MeasureSinglePatch 33 Z;RequestYState 36 2 [PrepareY (3,6)];
...
BellBasedCNOT 3 37 38 39 [BellMeasure (1,9),(1,8);MergeContract (0,8),(0,9)];MeasureSinglePatch 37 Z;RequestYState 40 3 [PrepareY (3,8)];
...
BellBasedCNOT 4 41 42 43 [BellMeasure (1,11),(1,10);MergeContract (0,10),(0,11)];MeasureSinglePatch 41 Z;RequestYState 44 4 [PrepareY (3,10)];
...
BellBasedCNOT 5 45 46 47 [BellMeasure (3,1),(3,2);MergeContract (4,0),(4,1)];MeasureSinglePatch 45 Z;RequestYState 48 5 [PrepareY (5,2)];
...
BellBasedCNOT 6 49 50 51 [BellMeasure (1,5),(2,5);BellMeasure (3,5),(3,4);MergeContract (0,4),(0,5)];MeasureSinglePatch 49 Z;RequestYState 52 6 [PrepareY (5,4)];
...
BellBasedCNOT 7 53 54 55 [BellMeasure (1,7),(2,7);BellMeasure (3,7),(3,6);MergeContract (0,6),(0,7)];MeasureSinglePatch 53 Z;RequestYState 56 7 [PrepareY (5,6)];
...
BellBasedCNOT 8 57 58 59 [BellMeasure (1,9),(2,9);BellMeasure (3,9),(3,8);MergeContract (0,8),(0,9)];MeasureSinglePatch 57 Z;RequestYState 60 8 [PrepareY (5,8)];
...
BellBasedCNOT 9 61 62 63 [BellMeasure (5,11),(5,10);MergeContract (4,12),(4,11)];MeasureSinglePatch 61 Z;RequestYState 64 9 [PrepareY (3,10)];
...
BellBasedCNOT 10 65 66 67 [BellMeasure (5,1),(5,2);MergeContract (6,0),(6,1)];MeasureSinglePatch 65 Z;RequestYState 68 10 [PrepareY (7,2)];
...
BellBasedCNOT 11 69 70 71 [BellMeasure (1,5),(2,5);BellMeasure (3,5),(4,5);BellMeasure (5,5),(5,4);MergeContract (0,4),(0,5)];MeasureSinglePatch 69 Z;RequestYState 72 11 [PrepareY (7,4)];
...
BellBasedCNOT 12 73 74 75 [BellMeasure (1,5),(2,5);BellMeasure (3,5),(4,5);BellMeasure (5,5),(5,6);MergeContract (0,6),(0,5)];MeasureSinglePatch 73 Z;RequestYState 76 12 [PrepareY (7,6)];
...
BellBasedCNOT 13 77 78 79 [BellMeasure (5,11),(5,10);BellMeasure (5,9),(5,8);MergeContract (6,12),(6,11)];MeasureSinglePatch 77 Z;RequestYState 80 13 [PrepareY (7,8)];
...
BellBasedCNOT 14 81 82 83 [BellMeasure (5,11),(5,10);MergeContract (4,12),(4,11)];MeasureSinglePatch 81 Z;RequestYState 84 14 [PrepareY (7,10)];
...
BellBasedCNOT 15 85 86 87 [BellMeasure (7,1),(7,2);MergeContract (8,0),(8,1)];MeasureSinglePatch 85 Z;RequestYState 88 15 [PrepareY (9,2)];
